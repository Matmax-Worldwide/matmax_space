    ...
    <div className="relative">
      {isConnected ? (
        ...
        <button
          ...
          className="flex items-center px-3 py-1.5 rounded-full bg-primary/10 hover:bg-primary/20 text-primary text-sm"
        >
        ...
        <button
          ...
          className="flex items-center px-3 py-1.5 rounded-full bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-sm"
        >
          <Wallet className="w-4 h-4 mr-2" />
      ...
      {isConnected && open && (
        <div className="absolute right-0 mt-2 w-64 bg-card rounded-lg shadow-lg z-50 border border-border overflow-hidden">
          ...
          <div className="p-2">
            ...
            <button
              ...
              className="w-full flex items-center px-3 py-2 text-sm rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-800 text-error"
            >
