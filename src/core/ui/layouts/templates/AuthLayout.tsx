  ...
  const AuthLayoutContent = () => {
    ...
    return (
      <div className="flex min-h-screen bg-background relative">
        ...
        {/* Logo and greeting (visible on medium screens and up) */}
        <div className="hidden md:flex md:w-1/2 relative z-10 flex-col items-center justify-center p-10 text-center">
          <Logo 
